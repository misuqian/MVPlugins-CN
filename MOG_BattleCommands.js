...
/*:
* @plugindesc (v1.0) Animated battle commands by images.动态的图片战斗信息
* @author Moghunter
*
* @param Mode
* @desc Definition of the command type.
* 0 - Normal 1 - Ring Menu
* @default 0
*
* @param X-axis layout
* @desc Definition X-Axis of the image.
* @default -45
*
* @param Layout Y-axis
* @desc Definition Y-Axis of the image.
* @default -25
*
* @param With X-axis
* @desc Definition X-Axis of the image.
...
*
* @param Arrow
* @desc Activate the image of the arrows.
* @default true
*
* @param Arrow X-axis
* @desc Definition X-Axis of the image.
...
*
* @param Zoom Loop
* @desc Enable loop in zoom animation.
* @default true
*
...
*
* @param Slide X
* @desc Definition of distance X.
* @default 30
*
* @param Slide Y
* @desc Definition of distance Y.
* @default 0
*
* @param With Name
* @desc Activate the command name.
* @default false
*
* @param Com Name X-axis
* @desc Definition X-Axis of the name.
* @default 55
*
* @param Com Name Y-axis
* @desc Y-Axis definition of the name.
* @default 75
*
* @param With Font Size
...
*
* @param Cursor X-axis
* @desc X-Axis definition of the cursor.
* @default 0
*
* @param Cursor Y-axis
* @desc X-Axis definition of the cursor.
...
*
* @param Cursor Slide
* @desc Enable slideshow animation.
* @default true
*
* @param Row Max
* @desc Definition of quantity commands visible.
* @default 4
*
* @param Ring Range
* @desc Definition of the circumference of the circle.
* @default 70
*
* @param Ring Motion
* @desc Enable motion animation.
* @default true
*
* @param Pi Range
* @desc Definition of PI value.
* @default 2.0
*
* @param Side Input
* @desc Enable Input to the right and left side.
* @default true
*
* @help
* ================================================================= ============================
...
* ================================================================= ============================
* Battle commands animated by images.
* This plugin requires MOG_BattleHud to work.
* (动态的图片战斗信息.依赖MOG_BattleHud插件）
* ================================================================= ============================
* Command images should be written to the /img/battlecommands/
* The names of the images should follow the following naming.
* (信息中的图片需要保存在/img/battlecommands目录下,图片命名按以下格式:)
