...
/*:
* @plugindesc (v1.3) Skill Chain Combos.
* @author Moghunter
*
* @param X-Axis
* @desc General X-axis definition.
* @default 0
*
* @param Y-Axis
* @desc General Y-axis definition.
* @default 0
*
* @param Key X-Axis
* @desc Definition of the X-axis of the button.
* @default 16
*
* @param Key Y-Axis
* @desc Y-axis definition of the button.
* @default -32
*
* @param Gauge X-Axis
* @desc X-axis definition of the time meter.
* @default 17
*
* @param Gauge Y-Axis
* @desc Y-axis definition of the time meter.
* @default 1
*
* @param Name X-Axis
* @desc X-axis definition of the skill name.
* @default 15
*
* @param Name Y-Axis
* @desc Y-axis definition of the skill name.
* @default 18
*
* @help
* ================================================================= ============================
...
* ================================================================= ============================
* The system allows you to execute combos by executing the sequence of buttons.
...
* USE
* ================================================================= ============================
* Use the comment below in the skill notes box.
*
* Chain Action: SKILL_ID: NUMBER_OF_INPUTS: INPUT_TIME
*
* SKILL_ID - Skill ID.
* NUMBER_OF_INPUTS - Number of times to push the button.
* INPUT_TIME - Time to press the buttons.
*
* (Example)
*
...
* HITÓRICO
* ================================================================= ============================
* (1.3) - Fixed the error of activating the command at the end of the battle.
* (1.2) - Fixed the compatibility code.
* (1.1) - Fixed the error of allowing input during the collapse of the enemy.
*
*/
