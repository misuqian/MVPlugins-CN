...
/*:
* @plugindesc (v1.9) Adds the animation of aura and particles in the enemies.(为敌人增加特效和粒子效果,需要自己设置图片)
* @author Moghunter
 +
* @help
* ================================================================= ============================
...
* ================================================================= ============================
* Adds aura and particle animation to enemies.
* Images of the aura and particles should be recorded on 
* the Same folder as the battlers /img/sv_enemies/ or img/enemies/
*(为敌人增加特效和粒子效果.特效和粒子效果图片需要保存在相同目录下,
* 目录在/img/sv_enemies或者img/enemies/二选一)
*
* ================================================================= ============================
* To activate the aura use the tag below in the notes box.
* (特效在敌人的备注栏里面写下如下格式文字:)
*
* aura effect: TYPE: FILE_NAME: OPACITY: BLENDMODE: ROTATION
*
* TYPE - Animation type (0 to 1)(类型：0或1)
* FILE_NAME = Filename. (Define as "battler" if you want to use the image of the
* Battler)（图片文件名字）
* BLENDMODE = Blend Mode(混合模式:1或0)
* ROTATION = Rotate the image.(是否旋转:true或false)
*
* Example(比如:)
* aura effect: 0: 文件名: 255: 1: true
*
* ================================================================= ============================
* To activate the particles use the tag below in the notes box.
* (例子效果在敌人的备注栏里面写下如下格式文字:)
*
* particle effect: POWER: FILE_NAME: BLEND_MODE: SPEED_X: SPEED_Y
*
* POWER - Amount of particles.(粒子数量)
* FILE_NAME - Filename.(图片文件名字)
* BLEND_MODE - Blend Type.(混合模式:1或0)
* SPEED_X - X-Axis motion speed.(X轴运动速度)
* SPEED_Y - Y-Axis movement speed.(Y轴运动速度)
*
* Example(比如：)
* particle effect: 20: 文件名: 0: 3: 3
*
* ================================================================= ===========================
* HISTORIC
* ================================================================= ===========================
* (V1.9) - Correction to present the aura on hidden enemies.
*
