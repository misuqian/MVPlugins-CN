...
/*:
* @plugindesc (v1.4) Adds a Hud with the character parameters.在主界面左下角增加人物信息面板
* @author Moghunter
*
* @param Initial Visible
* @desc Activate Hud at the beginning of the game.
* @default true
*
* @param Hud X-Axis
...
* @desc Display the EXP meter
* @default true
*
* @param EXP Meter X-Axis
* @desc Definition of the X-Axis position of the EXP meter.
* @default 127
*
* @param EXP Meter Y-Axis
* @desc Definition of the Y-Axis position of the EXP meter.
* @default 173
*
...
* @desc Display the Level number.
* @default true
*
* @param Level Number X-Axis
* @desc Definition of the X-Axis position of the Level number.
* @default 65
*
* @param Level Number Y-Axis
* @desc Definition of the Y-Axis position of the Level number.
* @default 153
*
* @param >> STATES ===================
* @desc
...
* ================================================================= ============================
* Add a Hud with character parameters.The files will be needed. (img/actorhud/):
* (在主界面左下角增加人物信息面板,img/actorhud目录下需要以下图片文件:)
* HP_Meter.png
* HP_Number.png
* MP_Meter.png
* MP_Number.png
...
*
* ================================================================= ============================
* To hide or display hud use the codes below through the PLUGIN COMMAND.
* (在PLUGIN COMMAND中输入以下两个可以控制界面显示：)
* Hide_actor_hud（隐藏界面）
* Show_actor_hud（显示界面）
*
* ================================================================= ===========================
* HISTORIC(更新日志)
* ================================================================= ===========================
* (V1.4) - Correction of crash when states is in false.
* (V1.3) - Addition of hide hud at the beginning of the game.
* (V1.2) - HP number position setup correction.
* (V1.1) - Blink correction to hud in hud hide mode.
*
