...
/*:
* @plugindesc (v1.8) Adds indication arrows to the selected targets.为选择目标增加指示箭头
* @author Moghunter
*
* @param X-Axis
...
*
* @param Name X-Axis
* @desc X-axis definition of the name.
* @default 0
*
* @param Name Y-Axis
...
*
* @param Float Effect
* @desc Enable the float effect on the cursor.
* @default true
*
* @param Sort X-Axis
* @desc Sort the order of enemies based on the X-axis.
* @default true
*
* @param Window Visible
* @desc Display the target window.
* @default false
*
* @param Touch Selection
* @desc Select targets by "clicking" on targets.
* @default true
*
* @param Help All Allies
* @desc Definition of text in all targets mode.
* @default All Allies
*
...
* @help
* ================================================================= ============================
* +++ MOG - Battle Cursor (v1.8) +++
* By Moghunter
* https://atelierrgss.wordpress.com/
* ================================================================= ============================
* Add target arrows to the selected targets.
* (为选择目标增加指示箭头)
* ================================================================= ============================
* Images of the cursors should be saved in the folder /img/system/
* (箭头光标图片需要保存在/img/system目录下,格式如下:)
* BattleCursor_A.png
* BattleCursor_B.png
*
* ================================================================= ============================
* If you want to adjust the cursor position based on the enemy, place this
* Comment on the enemy's notes box.
* (如果你想动态修改敌人的光标位置,在敌人的注释中写下如下格式:)
* Arrow Offset: X: Y
*
* Example(比如:)
* Arrow Offset: 25:30
...
* HISTORIC
* ================================================================= ===========================
* (V1.8) - Adding Touch Input to the Faces * (Battle Hud EX Requires)
* - Correction to display the cursor when the sprite is null.
*
