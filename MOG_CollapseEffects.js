...
/*:
* @plugindesc (v1.2) Adds animated collapse effects.
* @author Moghunter
*
* @param Default Collapse
* @desc Definition of default collapse;
* (0 to 10) (-1 = No Effect / -2 = Random Effects)
* @default 0
*
* @param Shatter Direction
* @desc Definition of the direction of Collapse in mode 0;
* @default Left
*
* @help
* ================================================================= ============================
...
* ================================================================= ============================
* Add effects of animated collapses.
*
* ================================================================= ============================
* COLLAPSE EFFECT (SKILL & ENEMY)
* ================================================================= ============================
* To force an effect use use the tags below in the enemy notes box
* Or SKILLs.
*
* Collapse Effect: EFFECT_ID
*
* EFFECT ID = Effect Type (0 to 10)
...
* ================================================================= ============================
* To force an animation use the following tags in the enemy's notes box
* Or SKILLs.
*
* Collapse Animation: ANIMATION_ID
*
* ANIMATION_ID = Definition of the database animation ID.
*
* ================================================================= ============================
* HISTORIC
* ================================================================= ============================
* (1.2) - Correction of the error referring to the index.
* (1.1) - Improved coding.
* ================================================================= ============================
*/
