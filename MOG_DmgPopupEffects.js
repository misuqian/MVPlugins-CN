...
/*:
* @plugindesc (v1.0) Adds some effects to the damage sprites.
* @author Moghunter
*
* @param Duration
* @desc Duration of damage.
* @default 90
*
* @param PopUp Type
* @desc Animation Type.
...
*
* @param Center Y-Axis
* @desc Centralize the position of the damage based on the battler's height.
* @default true
*
* @help
* ================================================================= ============================
...
* ================================================================= ============================
* Adds some effects on damage sprites and new Strings.
*
* It is necessary that the image has the height divided by 8 so that the images
* Stay aligned. (Default is 5)
*
* ================================================================= ============================
* You can adjust the damage position using the comment below in
* Box of notes.
*
* Damage Offset: X: Y
*
