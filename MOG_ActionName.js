...
/*:
 * @plugindesc (v1.0) Displays a window with action name.显示一个带动作名称的窗口.
 * @author Moghunter
 *
 * @param Layout X-Axis
 ...
 *
 * @param Name X-Axis
 * @desc X-Axis Name Position.
 * @default 0
 *
 * @param Name Y-Axis
 * @desc Y-Axis Name Position.
 * @default 24 
 *
 * @param Icon X-Axis
 * @desc X-Axis Position of the Icon.
 * @default 0 
 *
 * @param Icon Y-Axis
 * @desc Y-Axis Position of the Icon.
 * @default -4
 *
 * @param Font Size
 ...
 * =============================================================================
 * Displays a window with action name.
 * You will need to have the file. (Img / system /)
 * ActionNameA.png
 * 战斗中显示动作信息提示的窗口。必须要设置背景图片文件:Img/system/ActionNameA.png
 *      
 * =============================================================================
 * Disable Name
 * =============================================================================
 * Initially all actions will have the name activated, in case you want to disable
 * Any name, use the comment below in the Item / Skill box.
 * Disable Name
 * 如果你不希望显示物品或者技能名字,在备注里面写上:Disable Name
 *
