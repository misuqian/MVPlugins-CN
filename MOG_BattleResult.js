...
/*:
* @plugindesc (v1.1) Modifies the display screen.定制战斗结果显示界面
* @author Moghunter
*
* @param Exp X-Axis
* @desc X-Axis position of EXP.
* @default 760
*
* @param Exp Y-Axis
* @desc Y-Axis position of EXP.
* @default 160
*
* @param Gold X-Axis
* @desc Position X-Axis of Gold.
* @default 760
*
* @param Gold Y-Axis
* @desc Position Y-Axis of Gold.
* @default 230
*
* @param Treasure -Axis
* @desc X-Axis position of the tersouro.
* @default 32
*
* @param Treasure Y-Axis
* @desc Position Y-Axis of the treasure.
* @default 330
*
* @param Actor X-Axis
* @desc X-Axis character position.
* @default 250
*
* @param Actor Y-Axis
* @desc Position Y-Axis character.
* @default 0
*
* @param Real X-Axis Parameter
* @desc X-Axis position of the parameters.
* @default 0
*
* @param Real Y-Axis Parameter
* @desc Y-Axis position of the parameters.
* @default 0
*
* @param Parameter 1 X-Axis
* @desc X-Axis position of the parameters before the level-up.
* @default 550
*
* @param Parameter 1 Y-Axis
* @desc Y-Axis position of the parameters before the level-up.
* @default 140
*
* @param Parameter 2 X-Axis
* @desc X-Axis position of the parameters after the level-up.
* @default 700
*
* @param Parameter 2 Y-Axis
* @desc Y-Axis position of the parameters after the level-up.
* @default 140
*
* @param New Skill X-Axis
* @desc X-Axis position of the new ability.
* @default 570
*
* @param New Skill Y-Axis
* @desc Position Y-Axis of the new ability.
* @default 520
*
* @param Name X-Axis
* @desc Position X-Axis of the character's name.
* @default 155
*
* @param Name Y-Axis
* @desc Position Y-Axis of the character's name.
* @default 540
*
* @help
* ================================================================= ============================
...
* ================================================================= ============================
* Modifies the display screen.定制战斗结果显示界面
* ================================================================= ============================
...
* ACTOR PICTURE
* ================================================================= ============================
* Images should be saved in the /img/picture/
* Name the images as follows.
* (角色图片需保存在/img/picture目录下.命名格式如下:)
* Actor_ ID
*
* Example(比如:)
* Actor_1.png
...
* HISTORIC
* ================================================================= ============================
* (V1.1) - Correction of not displaying the status window in the next battle.
*
