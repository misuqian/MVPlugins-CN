...
/*:
* @plugindesc (v1.4) Adds voices in battle.战斗中增加音效
* @author Moghunter
*
* @param Volume
* @desc Volume setting.
...
* ================================================================= ============================
* Adds voices in battle (action, damage, victory, etc ...)
* To set the voices, you need to edit the plugin manually.
* The editing of the plugin must be made from line 70.
* 战斗中增加音效.你需要自己修改插件中的代码数组,70行开始
* ================================================================= ============================
* HISTORIC
* ================================================================= ============================
* (V1.4) - Correction of playing the voices in the menu.
* - Correction of not updating the enemy ID in the transformation effect.
* (V1.3) Compatibility with MOG Battle Result.
* (V1.2) Compatibility with MOG Battle Transitions.
* (V1.1) Fixed the bug not moving the character at the time of action.
*
